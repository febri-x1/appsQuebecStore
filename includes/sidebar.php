...
<aside class="sidebar d-flex flex-column">
    ...
    <?php if ($user): ?>
        <nav class="d-flex flex-column gap-2 flex-grow-1">
            ...
            <?php if (($user['role'] ?? '') !== 'kasir'): ?>
                <a href="<?= BASE_URL; ?>/barang/index.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/barang/') !== false ? 'active' : '' ?>">
                    <i class="bi bi-box-seam-fill"></i> <span>Barang</span>
                </a>
            ...
            <a href="<?= BASE_URL; ?>/laporan/index.php" class="nav-link <?= strpos($_SERVER['REQUEST_URI'], '/laporan/') !== false ? 'active' : '' ?>">
